<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Администрирование</span>
        </a>
    </div>
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('{{ asset('img/admin/curved-images/white-curved.jpeg') }}')"></div>
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="#" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Документация</a>
                </div>
            </div>
        </div>
        <a class="btn bg-gradient-primary mt-4 w-100" href="#" type="button">Написать нам</a>
    </div>
</aside>
